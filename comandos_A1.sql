/* Se crean las tablas para el databse */
...
/* Se insertan los datos a las tablas */
INSERT INTO clientes VALUES('3623344710', 'Marcos Rosas', 'Av. Universidad', 'Del Valle', 'Ciudad de México', 
'EM', '22002012', '1995-01-13', 26, 'M', 110000, 220000, 1);
...
/* Se copian los datos de jugos_ventas a las tablas del nuevo schema */
INSERT INTO items
...
SELECT * FROM facturas F INNER JOIN items I ON F.NUMERO = I.NUMERO;
